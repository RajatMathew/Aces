...
const LightRegistration = ({ data }) => {
    ...
    return (
        <>
            <Head>
                <title>Aces | Light&Sound/Jamroom</title>
                            ...
                            <div className="relative px-4 sm:px-6 lg:px-8 pb-8 mx-auto" x-data="{ card: true }">
                                <div className="bg-gray-800 px-8 pb-6 rounded-b shadow-lg">
                                    ...
                                    <div className="text-center">
                                        <h3 className="text-xl font-medium leading-6 text-gray-200">Light&Sound/Jamroom Registration</h3>
                                        <p className="mt-4 text-sm leading-5 text-gray-500">
                                            Please fill in the form to register your Light&Sound/Jamroom.
                                        </p>
                                    </div>
                                        ...
                                        <div className="flex flex-wrap ">
                                            <div className="w-full my-2">
                                                <label className="block text-sm font-medium leading-5 text-gray-400">
                                                    Light&Sound/Jamroom Name
                                                </label>
                                                <div className="mt-1 rounded-md shadow-sm">
                                                    <input
                                                        id="Light&Sound/Jamroom_name"
                                                        type="text"
                                                        required
                                                        ...
                                                        placeholder="Light&Sound/Jamroom Name"
                                                    />
                                                </div>
                                            </div>
                                            <div className="w-full my-2">
