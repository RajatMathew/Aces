                            ...
                            <div className="relative px-4 sm:px-6 lg:px-8 pb-8 mx-auto" x-data="{ card: true }">
                                <div className="bg-gray-800 px-8 pb-6 rounded-b shadow-lg">
                                    ...
                                    <div className="text-center">
                                        <h3 className="text-xl font-medium leading-6 text-gray-200">Dance Registration</h3>
                                        <p className="mt-4 text-sm leading-5 text-gray-500">
                                            Please fill in the form to register your Photographer.
                                        </p>
                                    </div>
                                    <form className="mt-6" action="#" method="POST">
                                        ...
                                        <a type="primary" href="/photographer/photographerMemberRegistraion">Next</a>
                                    </form>
                                </div>
                            </div>
                        </div>
